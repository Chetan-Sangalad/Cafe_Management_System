...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <!-- .navbar -->
            <nav class="navbar navbar-dark" width="30" >
                <div class="container">
                    <button class="navbar-toggler hidden-lg-up" width="30" type="button" data-toggle="collapse" data-target="#mainNavbarCollapse">&#9776;</button>
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/nittelogo.jpg" width=30
                     alt=""> </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpg">
            ...
            <br>
            <br>
                     <div  class="hero-outer" align='center' style="font-size: 20px;">4NM22CS402    CHETAN</div><br>
                     <div class="hero-outer" align="center" style="font-size: 20px;">4NM22CS403    DEEKSHITH</div><br>
                     <div  class="sir" align='center' style="font-size: 25px;">SUBMITTED TO</div>
                     <div class="hero-outer" style="font-size: 30px;" align="center">DR. PRADEEP KANCHAN</div>
                     <div  class="sir" align='center' style="font-size: 20px;">Assistant Professor Gd-III</div><br><br><br>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose cafe</h4> </div>
                        <!-- end:Step -->
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/nittelogo.jpg" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                                <li><a href="#">nitte</a> </li>
                                <li><a href="#">karkala</a> </li>
                                <li><a href="#">belman</a> </li>
                                <li><a href="#">padubidri</a> </li>
                                <li><a href="#">udupi</a> </li>
                                <li><a href="#">mangalore</a> </li>
                                <li><a href="#">Bangalore</a> </li>
                                <li><a href="#">hubballi</a> </li>
                                <li><a href="#">Gadag</a> </li>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>Concept design of oline food order and deliveye,planned as cafe directory</p>
                            <h5>Phone: <a href="tel:+080000012222">080 000012 222</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                            <p>Join the thousands of other cafe who benefit from having their menus on TakeOff</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
